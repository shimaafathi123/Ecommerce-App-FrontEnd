...
// import CustomNavbar from '../Navbar/Navbar';
// import { fetchCart } from '../../axios/cartApi';
...
//           const cartData = await fetchCart(username, token);
    ...
    return (
        <>
            ...
            <div className="container m-5">
                <div className="d-flex justify-content-between align-items-center mt-5">
                    <h1 className="mt-5 text-dark">Shopping Cart</h1>
                    <button onClick={handleClearCart} className="btn btn-danger mt-5">Clear Cart</button>
                </div>
                <table className="table mt-4">
                    <thead>
                        <tr>
